...
HD_PWD='C:/Users/Public/Documents/Chaos/Chaos_Encryption/Chaos_Encryption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encryption.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encryption.tcl
